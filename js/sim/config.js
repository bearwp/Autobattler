...
export const CONFIG = {
  ...
  // Doors
  doors: {
    entrance: { x: 12, y: 0, width: 2 },   // top
    exit:     { x: 12, y: 16, width: 2 },  // bottom
  },
  ...
  units: {
    tank:    { hp: 300, atk: 15, range: 1.2, speed: 2.2, armor: 8,  color: '#3b82f6', shape: 'square',   size: 0.9 },
    soldier: { hp: 180, atk: 30, range: 1.2, speed: 3.0, armor: 4,  color: '#ef4444', shape: 'square',   size: 0.7 },
    archer:  { hp: 100, atk: 40, range: 7.0, speed: 3.0, armor: 0,  color: '#22c55e', shape: 'triangle', size: 0.7 },
    healer:  { hp: 80,  atk: 0,  range: 5.0, speed: 3.0, armor: 0,  color: '#f8fafc', shape: 'circle',   size: 0.7 },
  },
  ...
  // Abilities
  abilities: {
    taunt: { cooldown: 4.0, radius: 4.0, threat: 100 },
